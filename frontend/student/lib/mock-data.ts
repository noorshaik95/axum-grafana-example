...
export const mockAssignments = [
  {
    ...
    instructions:
      'Create a Python program that implements a binary search tree. Include comprehensive tests.',
    points: 100,
    dueDate: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(),
    submittedAt: null,
...
export const mockDiscussions = [
  {
    ...
    content:
      'What are some tips for writing clean recursive functions? I sometimes struggle with base cases.',
    isPinned: true,
    isLocked: false,
    views: 127,
    replyCount: 8,
